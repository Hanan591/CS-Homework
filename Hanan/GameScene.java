...
public class GameScene {
    ...
    public void start() {
        ...
        if (carChoice == 1) {
            ...
            player.addItem(new Item("Backup Signal"));
        } else {
        ...
        if (hackingChoice == 1) {
            ...
            player.addItem(new Item("Encrypted File"));
        } else {
        ...
        if (rescueChoice == 1) {
            ...
            if (subChoice == 1 && player.useItem("Lockpick")) {
                ...
                System.out.println("You find a ventilation shaft and crawl through, but it takes time.");
                player.takeDamage(10);
            } else {
        ...
        if (player.getHealth() > 0) {
            ...
            if (player.getHealth() > 0) {
                ...
                System.out.println("You succumb to your injuries. Game over.");
            }
        } else {
